...
`USE_S3_THEMES`             If `Flask-Themes <http://pythonhosted.org/Flask-Themes/>`_
                            is used, static files used in all themes and loaded
                            using ``theme_static`` will be served from S3 as
                            well.
                            **Default:** `False`
